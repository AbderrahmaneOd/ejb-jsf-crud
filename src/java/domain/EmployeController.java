...
public class EmployeController implements Serializable {
    ...
    List<Machine> machinesForSelectedEmploye;
    ...
    public List<Machine> getMachinesForSelectedEmploye() {
        if (selected != null) {
        //return ejbFacade.findMachinesByEmploye(selected);
        return selected.getMachineList();
    }
    return new ArrayList<>();
    }

    public void setMachinesForSelectedEmploye(List<Machine> machinesForSelectedEmploye) {
        this.machinesForSelectedEmploye = machinesForSelectedEmploye;
    }
